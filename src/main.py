...
tileMapAssetList = [
    ...
    r"src\asset\mapTiles\tree bottom side.png",         #18
    r"src\asset\mapTiles\tree left side.png",           #19
    r"src\asset\mapTiles\tree middle.png",              #20
    r"src\asset\mapTiles\tree right side.png",          #21
]
